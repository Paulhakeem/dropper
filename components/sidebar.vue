<template>
  <div>
    <button
      ...
      type="button"
      class="inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none"
    >
        ...
        <ul class="space-y-2 font-medium">
          <li>
            ...
            >
              ...
              <span class="ms-3 text-text-color">Dashboard</span>
            </a>
          </li>
          ...
          <li>
            ...
            <img src="/bell.svg" alt="">
              <span class="flex-1 ms-3 whitespace-nowrap text-text-color"
                >Notification</span
              >
              <span v-if="useStorage.notification"
                ...
                >{{useStorage.notification}}</span
              >
               <span v-else
                class="inline-flex items-center justify-center text-text-color w-3 h-3 p-3 ms-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300"
                >{{useStorage.errorMessage}}</span
              >
            </a>
          </li>
          <li>
